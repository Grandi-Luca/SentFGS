...
# simplify the token and create the mapping dictionary 
...
def simplify_amr_hal(amr_data, data_hal_amr, doc_graph=False):
    try:
        ...
        #takes a string in Penman notation and returns a graph object that can be manipulated in Python.
        graph_penman = penman.decode(amr)
        v2c_penman = create_set_instances(graph_penman)
        # takes a graph object and returns a string in Penman notation.
